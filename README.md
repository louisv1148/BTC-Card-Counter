...
│   └── scripts/
│       ├── deploy_btc_lambdas.sh     # Deploy all BTC Lambdas
│       ├── setup_btc_dynamodb.sh     # Create BTCPriceHistory table
│       ├── setup_trade_log.sh        # Create BTCTradeLog table
│       └── setup_volatility_api.sh   # Setup API Gateway
│
├── eth/
│   ├── lambda_package/
...
│   └── scripts/
│       ├── deploy_eth_lambdas.sh     # Deploy ETH Lambdas
│       ├── setup_eth_dynamodb.sh     # Create ETHPriceHistory table
│       └── setup_volatility_api.sh   # Setup ETH API Gateway
│
├── weather/
│   ├── lambda_package/
...
│   └── scripts/
│       ├── deploy_lambda.sh          # Deploy weather Lambda
│       ├── setup_dynamodb.sh         # Create weather DynamoDB table
│       └── setup_eventbridge.sh      # Setup weather triggers
│
├── scripts/
│   ├── price_history_cleanup.py      # Cleanup Lambda (180 min retention)
│   └── deploy_cleanup_lambda.sh      # Deploy cleanup Lambda
│
└── README.md
```
